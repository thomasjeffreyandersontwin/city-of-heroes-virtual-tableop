...
namespace HeroVTT.Roster
{
    public class ActiveCharacterWidgetViewModel : BaseViewModel
    {
        ...
        #region Constructor
        public ActiveCharacterWidgetViewModel(IBusyService busyService, IUnityContainer container, EventAggregator eventAggregator, IRosterGameState rosterGameState = null)
        ...
        {
            _rosterGameState.CurrentActiveWindowName = panelName;
        }

        private void DeactivatePanel(string panelName)
        {
            if (_rosterGameState.CurrentActiveWindowName == panelName)
                _rosterGameState.CurrentActiveWindowName = "";
        }
